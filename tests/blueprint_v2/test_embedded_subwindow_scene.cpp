...
TEST(EmbeddedSubwindowScene, RebuildFromInlineDefIndependent) {
    ...
    visual::Scene scene;
    visual::mutations::rebuild(scene, inline_bp, interner, arena, "", ComponentRegistry{});
...
TEST(EmbeddedSubwindowScene, InlineDefIndependentOfRootShadows) {
    ...
    visual::mutations::rebuild(inline_scene, inline_bp, interner, arena, "", ComponentRegistry{});
    ...
    visual::mutations::rebuild(root_scene_filtered, root_bp, interner, arena, "composite_1", ComponentRegistry{});
...
TEST(EmbeddedSubwindowScene, RootWindowStillShowsRootNodes) {
    ...
    visual::mutations::rebuild(root_scene, bp, interner, arena, "", ComponentRegistry{});
    ...
    visual::mutations::rebuild(sub_scene, inline_bp, interner, arena, "", ComponentRegistry{});
...
TEST(EmbeddedSubwindowScene, CompositeHostPortsUseNestedAuthorityNotCollapsedCache) {
    ...
    visual::Scene root_scene;
    visual::mutations::rebuild(root_scene, root, interner, arena, "", ComponentRegistry{});
