...
TEST(BakeOps, BakeNestedReferenceToEmbedded) {
    ...
    reg.register_blueprint(I.intern("sub_type"), lib.iface(), "sub", &lib);
    ...
    bp2::Blueprint baked = bp2::bake_nested(root, I.intern("sub1"), reg);
...
TEST(BakeOps, TryUnbakeReturnsReferenceWhenExactMatchFound) {
    ...
    auto unbaked = bp2::try_unbake(root, I.intern("sub1"), reg);
...
TEST(BakeOps, BakeAllRecursivelyEmbedsReferences) {
    ...
    reg.register_blueprint(I.intern("grand_type"), grand.iface(), "grand", &grand);
    ...
    reg.register_blueprint(I.intern("child_type"), child.iface(), "child", &child);
    ...
    bp2::Blueprint baked = bp2::bake_all(root, reg);
...
TEST(BakeOps, BakeAllDetectsCyclicReferenceGraph) {
    ...
    reg.register_blueprint(I.intern("A"), a.iface(), "A", &a);
    reg.register_blueprint(I.intern("B"), b.iface(), "B", &b);
    ...
    EXPECT_THROW(bp2::bake_all(root, reg), std::runtime_error);
}
