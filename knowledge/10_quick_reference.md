...
| WASM Module Header | `wasm/an24_bridge.h` |
| WASM Module Source | `wasm/an24_bridge.cpp` |
| WASM Protocol Helpers | `wasm/bridge_protocol.h` |
| WASM Build Config | `wasm/CMakeLists.txt` |
| Panel Config Example | `wasm/panel.cfg.example` |
| Systems Config Example | `wasm/systems.cfg.example` |
