...
inline std::optional<ComponentKind> parse_component_kind(std::string_view name) {
    ...
    if (name == "SimConnectInput") return ComponentKind::SimConnectInput;
    if (name == "SimConnectOutput") return ComponentKind::SimConnectOutput;
...
inline constexpr std::string_view component_kind_classname(ComponentKind kind) {
    switch (kind) {
        ...
        case ComponentKind::SimConnectInput: return "SimConnectInput";
        case ComponentKind::SimConnectOutput: return "SimConnectOutput";
