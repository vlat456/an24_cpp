...
// ==============================================================================
// Split emit functions for port_queries.h (WITH all.h for variant)
// ==============================================================================
...
void emit_port_queries_lookups(
...
void emit_port_queries_traits(std::ostringstream& oss, const std::vector<ComponentPorts>& all_components) {
...
void CodeGen::generate_port_registry(const ComponentRegistry& registry, const std::string& output_path) {
    ...
    // 2. Emit port_queries.h (WITH all.h for variant)
    {
        std::ostringstream oss;
        emit_port_queries_prelude(oss);
        emit_port_queries_lookups(oss, all_components, all_port_names);
        emit_port_queries_traits(oss, all_components);
    ...
    // 3. Emit port_registry.h (convenience include of all 3)
    {
        std::ostringstream oss;
        oss << "// Auto-generated by codegen from library/*.blueprint\n";
        oss << "// DO NOT EDIT - changes will be overwritten\n";
        oss << "// This file includes all port-related headers for convenience.\n";
        oss << "// For minimal includes, include port_names.h, port_metadata.h, or port_queries.h directly.\n\n";
        oss << "#pragma once\n\n";
