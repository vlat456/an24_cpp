...
Systems::Systems()
{
    ...
    dmr_vsu.lamp_idx = 6;
    dmr_vsu.v_bus_mon_idx = 1;
    dmr_vsu.v_gen_in_idx = 4;
    dmr_vsu.v_out_idx = 1;
    light_1.v_out_idx = 0;
    light_1.brightness_idx = 7;
    light_1.v_in_idx = 1;
...
AOT_INLINE void Systems::step_0(void* state) {
    ...
    main_bus.solve_electrical(*st);
    vsu_1.solve_electrical(*st);
    rug_vsu.solve_electrical(*st);
    dmr_vsu.solve_electrical(*st);
...
void Systems::post_step(void* state, float dt) {
    ...
    main_bus.post_step(*st, dt);
    vsu_1.post_step(*st, dt);
    rug_vsu.post_step(*st, dt);
    dmr_vsu.post_step(*st, dt);
